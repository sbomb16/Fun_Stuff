...
public class Cat : MonoBehaviour {
    ...
    public void Launch()
    {
        ...
        if(launched == false)
        {
            ...
            Debug.Log(rigid);
            Debug.Log(mouse);
            Debug.Log(rigid.transform.position);

            Vector3 targetVect = calcFire.CalculateFiringSolution(rigid.transform.position, mouse.transform.position, launchForce, Physics.gravity);
